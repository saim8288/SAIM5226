...
\033[1;94mFACEBOOK  Badshah Tricker
   ...
   ╚═╝   ╚═╝  ╚═╝╚═╝ ╚═════╝╚═╝  ╚═╝╚══════╝╚═╝  ╚═╝
                         ...
                         DON'T COPY MY SCRIPT
                                      RED-MAFIA          
                                        TNX(RK)
╔══──────────────────────────╗─══╗
║OWNER 💓💓💓SAIM TRICKER(RK)                              ║
║  GITHUB 💝💝💝 saim8288                       ║
║ FACEBOOK 💝💝💝BADSAH-HACKER                 ║
║  ENJOY 💝💝💝Pak Cloning                             ║
║   Note 💝💝💝Use Fastest Speed Net             ║
╚══──────────────────────────╝─══╝
"""
print("""
Owner: SAIM-TRICKEE(R.K)
Facebook: BADSHAH-HACKER
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
	    ...
	    time.sleep(2)
            ...
            os.system('xdg-https://wa.me/+923176291071')
    else:
